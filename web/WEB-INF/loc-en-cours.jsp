        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tfoot>
                <tr>
                    <th colspan="7" class="text-success" style="font-size: 12px;">Recherche</th>
                </tr>
              </tfoot>
              <tbody>
              <c:forEach items="${lists}" var="l">
                 <tr>
                      <td>${l.idLocation.matricule}</td>
                            <td> <fmt:formatDate type = "both" dateStyle = "short" timeStyle = "short" value = "${l.idLocation.datedebut}" /></td>
                            <td><fmt:formatDate type = "both" dateStyle = "short" timeStyle = "short" value = "${l.idLocation.dateretour}" /></td>
                            <td>${l.idLocation.idvoiture.matricule}</td>
                            <td>${l.idLocation.idClient.nom}</td>
                            <td>${l.idLocation.idClient.prenom}</td>
                            <td>${l.idLocation.montant}</td>
                  </tr>  
              </c:forEach>
              </tbody>
            </table>
