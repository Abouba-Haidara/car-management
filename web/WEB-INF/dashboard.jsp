      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
              <a href="${pageContext.request.contextPath}/location?action=deleteclient">Listes sClient</a>
            </li>
            <li>
              <a href="${pageContext.request.contextPath}/location?action=listsclient">Listes sClient</a>
            </li>
          </ul>
        </li>
    ...
    <div class="container-fluid">
          <%-- Vérification de la présence d'un objet utilisateur en session --%>
                <c:if test="${!empty sessionScope.user}">
                    ...
                    <p class="succes">Bonjour <strong> ${sessionScope.user.client.nom} ${sessionScope.user.client.prenom}</strong>, Bienvenue<span class="pull-right">Role: <c:if test="${sessionScope.user.profile.id == 2}">Admin</c:if></span></p>
                </c:if>
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tfoot>
                <tr>
                    <th colspan="8" class="text-success" style="font-size: 12px;">Recherche</th>
                </tr>
              </tfoot>
              <tbody>
              <c:forEach items="${lists}" var="l">
                 <tr>
                  ...
                  <td>
                       <table>
                          <tr>
                              <td><a href="#" class="btn btn-sm fa fa-edit text-warning"></a></td>
                              <td><a href="#" class="btn btn-sm fa fa-remove text-danger"></a></td>
                          </tr>
                      </table>
                  </td>
                </tr>  
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Comfirmez?</h5>
