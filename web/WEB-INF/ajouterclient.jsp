...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" ng-controller="locationCtrl">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
             ...
             <li>
              <a href="${pageContext.request.contextPath}/location?action=listsclient">Afficher clients</a>
            </li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card-header">Inscription du Client</div>
      <div class="card-body">
          <form name="cl" action="${pageContext.request.contextPath}/location?action=saveclient" method="post">
          <div class="form-group">
            <label for="num">Matricule</label>
            <input class="form-control" id="num" type="text" name="matricule" value="${mat}" readonly>
          </div>
           <div class="form-group">
            <label for="nidn">Numero Piéce Identité / Numero Passport</label>
            <input class="form-control" id="nidn" type="text" name="nidn" value="">
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="n">Nom</label>
                <input class="form-control" id="n" type="text" ng-model="nom" name="nom" placeholder="Nom Locataire" required>
                <span ng-show="cl.nom.$dirty && cl.nom.$error.required">Le nom est Obligatoire</span>
              
              </div>
              <div class="col-md-6">
                <label for="p">Prenom </label>
                <input class="form-control" id="p" type="text"  ng-model="prenom" name="prenom" placeholder="Prenom Locataire" required>
                <span ng-show="cl.prenom.$dirty && cl.prenom.$error.required">Le prenom est Obligatoire</span>
              </div>
            </div>
          </div>
         <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="t" type="text" ng-model="telephone"  name="telephone" placeholder="Telephone Locataire" required>
                <span ng-show="cl.telephone.$dirty && cl.telephone.$error.required">Le Téléphone est Obligatoire</span>
              </div>
              <div class="col-md-6">
                <label for="a">Adresse </label>
                <input class="form-control" id="a" type="text"  ng-model="adresse" name="adresse"  placeholder="Adresse Locataire" required>
                <span ng-show="cl.adresse.$dirty && cl.adresse.$error.required">L'Adresse est Obligatoire</span>
              </div>
            </div>
          </div>
           <div class="form-group">
            <label for="nidn">BP : </label>
            <input class="form-control" id="nidn"  type="text" name="bp" value="">
          </div>
         <div class="form-group">
             <label for="idv">Raison  social</label>
                <div class="group-form " >
                     <label class="radio radio-inline">Mr
                         <input type="radio" name="genre" checked="checked" ng-model="genre" value="Mr" required>
                     <span class="checkround"></span>
                   </label>
                   <label class="radio radio-inline">Mme
                       <input type="radio"  name="genre" ng-model="genre" value="Mme" required>
                     <span class="checkround"></span>
                   </label>
                  <label class="radio radio-inline">Société|Entrprise
                       <input type="radio"  name="genre" ng-model="genre" value="en-soc" required>
                     <span class="checkround"></span>
                   </label>
             </div>
          </div>
            <button class="btn btn-primary btn-block" type="submit" ng-disabled="cl.$invalid">Valider</button>
        </form>  
      </div>
      </div>
    </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Deconnectez-vous?</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">Confirmer la decconection.</div>
