        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
             ...
             <li>
              <a href="${pageContext.request.contextPath}/location?action=deleteclient">Listes clients</a>
            </li>
          </ul>
        </li>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
              ...
              <tfoot>
                <tr>
                    <th colspan="9" style="font-size: 12px;" class=" bg-primary text-white">la liste de clients</th>
                </tr>
              </tfoot>
              <tbody>             
                ...
                <tr>
                  <td>${l.agence}</td>
                  <td>${l.idclient.nidn}</td>
                  <td>${l.idclient.nom} ${l.idclient.prenom}</td>
                  <td>${l.idclient.telephone} ${l.idclient.addresse}</td>
                  <td>${lidclient.genre}</td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">deconnectez-vouss?</h5>
